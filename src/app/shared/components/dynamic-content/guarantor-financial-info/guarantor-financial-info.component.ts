...
import { sectionMapping } from '../../../form-config/guarantor-financial-section-mapping';
import { fieldMapping } from "../../../field-config/guarantor-financial-info-field-mapping";
...
@Component({
    selector: 'app-guarantor-financial-info',
    templateUrl: './guarantor-financial-info.component.html',
    styleUrls: ['./guarantor-financial-info.component.scss'],
})
export class GuarantorFinancialInfoComponent extends BaseComponent implements OnInit, AfterViewInit, AfterViewChecked {
    ...
    private getCountryList() {
        if (!this.fieldProps.gtcountryOfIncome.hidden) {
    ...
    private getPersonalAssetAmtList() {
        if (!this.fieldProps.gtpersonalAssetAmt.hidden) {
    ...
    private getNcbList() {
        if (!this.fieldProps.gtncbSelfCreditScore.hidden) {
    ...
    public gtcountryOfIncomeSelectChange(countryName: string = "") {
        this.displayName.gtcountryOfIncome = countryName;
    }
}
