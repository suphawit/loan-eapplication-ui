...
import { sectionMapping } from '../../../form-config/guarantor-business-owner-section-mapping';
import { fieldMapping } from "../../../field-config/guarantor-business-owner-field-mapping";
...
@Component({
  selector: 'app-guarantor-business-owner',
  templateUrl: './guarantor-business-owner.component.html',
  styleUrls: ['./guarantor-business-owner.component.scss']
})
export class GuarantorBusinessOwnerComponent extends BaseComponent implements OnInit, AfterViewInit, AfterViewChecked {
    ...
    private getEmployeeNumList() {
        if (!this.fieldProps.gtnumberOfEmployee.hidden) {
