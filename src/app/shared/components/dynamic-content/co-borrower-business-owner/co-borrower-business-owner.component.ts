...
import { sectionMapping } from '../../../form-config/co-borrower-business-owner-section-mapping';
import { fieldMapping } from "../../../field-config/co-borrower-business-owner-field-mapping";
...
@Component({
  selector: 'app-co-borrower-business-owner',
  templateUrl: './co-borrower-business-owner.component.html',
  styleUrls: ['./co-borrower-business-owner.component.scss']
})
export class CoBorrowerBusinessOwnerComponent extends BaseComponent implements OnInit, AfterViewInit, AfterViewChecked {
